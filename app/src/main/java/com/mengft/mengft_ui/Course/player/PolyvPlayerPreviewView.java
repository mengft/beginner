...
public class PolyvPlayerPreviewView extends RelativeLayout {
    ...
    private void initViews() {
    	LayoutInflater.from(getContext()).inflate(R.layout.course_player_preview, this);
		mPreviewImage = (ImageView) findViewById(R.id.iv_course_player_preview_image);
		mStartBtn = (ImageButton) findViewById(R.id.ib_course_player_start);
		mStartBtn.setOnClickListener(new OnClickListener() {

			@Override
			public void onClick(View v) {
				if (onPreViewClickListener != null) {
					onPreViewClickListener.onClick();
				}
...
//					.showImageOnLoading(R.drawable.polyv_avatar_def) // 设置图片在下载期间显示的图片
